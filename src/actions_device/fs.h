struct string *fs_get_path(struct blocks *restrict block,struct string *restrict path);
...
bool movefile (char *source, char *dest, bool dest_is_dir, const struct cp_options *x, void (*update_status)(long unsigned int, void *), void *pass_ptr);
bool do_copy (int n_files, char **file, const char *target_directory, bool no_target_directory, struct cp_options *x, void (*update_status)(long unsigned int, void *), void *pass_ptr);
		 
void cp_option_init (struct cp_options *x);
